...
export default function UpdateProfile() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updatedUser = res.data?.user || res.data?.data?.user || res.data?.data || res.data;
  ...
  return (
    <PageTransition className="max-w-4xl mx-auto py-8 px-4">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Manage your public bio, social links, and details.</p>
      </div>
